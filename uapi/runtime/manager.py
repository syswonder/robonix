"""
Runtime Manager - Provides convenient interfaces for managing DeepEmbody runtime
"""
...
class RuntimeManager:
    """High-level manager for DeepEmbody runtime operations"""
    ...
    def register_entity_builder(self, name: str, builder_func: Callable[[Runtime], None]):
    ...
    def execute_action(self, action_name: str, wait: bool = True, timeout: float = 30.0):
