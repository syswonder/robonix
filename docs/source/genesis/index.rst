DeepEmbody OS 模拟器（基于 Genesis）
==================

Genesis 模拟器系统是 DeepEmbody 框架中的物理仿真组件，基于Genesis物理引擎构建了完整的机器人仿真环境。该系统采用模块化设计，通过场景管理、运动控制、相机系统和远程通信四个核心模块，提供了能够运行用户编写的具身应用程序的机器人仿真平台。
