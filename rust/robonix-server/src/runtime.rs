...
impl RuntimeClient {
    ...
    pub async fn register_query(
        ...
        let req = crate::meta_runtime::pb::RegisterQueryRequest {
            node_id: node_id.to_string(),
        ...
        let resp = self
            ...
            .register_query(req)
            .await
            .context("register_query RPC failed")?
            .into_inner();
    ...
    pub async fn resolve_query(
        ...
        let req = crate::meta_runtime::pb::ResolveQueryRequest {
        ...
        let resp = self
            ...
            .resolve_query(req)
            .await
            .context("resolve_query RPC failed")?
            .into_inner();
        Ok(resp.channel_name)
    }
}
