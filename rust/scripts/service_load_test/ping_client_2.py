#!/usr/bin/env python3
"""
High-intensity ping pong service test client - Node 2
...
class PingClient2(Node):
    """High-intensity ping pong test client node 2"""

    def __init__(self):
        super().__init__('ping_client_2')
        ...
        self.get_logger().info(f'Ping Client 2 starting high-intensity test on {self.service_name}')
    ...
    def _call_ping_service_native(self, sequence: int):
        ...
        try:
            ...
            request.message = f'ping from client 2'
                ...
                if success:
                    ...
                    if sequence % 100 == 0:
                        self.get_logger().info(
                            f'Client 2: Sent {sequence} requests, '
                    ...
                    if self.failed_requests % 10 == 0:
                        self.get_logger().warn(
                            f'Client 2: Failed request #{self.failed_requests}, '
    ...
    def _print_stats(self):
        ...
        with self.lock:
            ...
            self.get_logger().info(
                f'Client 2 Stats: Total={total}, Success={success}, Failed={failed}, '
