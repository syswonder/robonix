...
echo "Building demo_service_provider package..."
...
if [ -f "setup.py" ]; then
    $PYTHON3_EXECUTABLE -m pip install python-dotenv "openai>=1.0.0" --quiet
...
# Build demo_service_provider package using colcon
echo "Building demo_service_provider package with colcon..."
