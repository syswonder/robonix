...
| **prm_camera_vendor** | Camera vendor example: prm::camera (rgb, depth, rgbd, intrinsics); IR not implemented |
| **prm_arm_vendor** | Arm vendor example: prm::arm (move_ee, joint_trajectory) + prm::gripper (close, open) |
| **map_semantic_service** | Map service example: robonix/system/map/semantic_query |
...
See [ridlc §5 — user logic completion (Python)](https://github.com/syswonder/robonix-book/blob/main/src/chapter3-developer-guide/ridlc.md) for full documentation.
