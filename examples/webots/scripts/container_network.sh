...
# Address the sim container should dial back on. Host-network sim containers
# have no bridge IP, so fall back to localhost unless Docker reports a valid
# bridge IPv4. Callers must have SIM_CT set.
