...
docker exec -i \
  ...
  -e PYTHONPATH="/robonix_pkgs/pylib/robonix-py:/robonix_pkgs/primitives/tiago_lidar/rbnx-build/codegen/proto_gen:/robonix_pkgs/primitives/tiago_lidar/rbnx-build/codegen/robonix_mcp_types" \
  robonix_tiago_sim \
  bash -lc "
    set -eo pipefail
