...
// Vitals proto codegen: ROS IDL + contract TOML → .proto (via robonix-codegen
// as a library) → tonic Rust stubs. All artefacts in OUT_DIR; nothing
// committed. Atlas wire types are NOT regenerated here — vitals reaches
